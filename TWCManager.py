    ...
    try:
        ...
        if msgLen >= 16:
            ...
            if config["config"]["fakeMaster"] == 1:
                ...
                if msgMatch and foundMsgMatch == False:
                    print("msgMatch and foundMsgMatch == False (line 737)")
                    ...
                    print("Assigned msgMatch (line 850)")
                if msgMatch and foundMsgMatch == False:
                    print("msgMatch and foundMsgMatch == False (line 849")
                ...
                if msgMatch and foundMsgMatch == False:
                    print("msgMatch and foundMsgMatch == False (line 910)")
